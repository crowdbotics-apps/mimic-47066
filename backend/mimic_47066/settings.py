"""
Django settings for mimic_47066 project.
...
WSGI_APPLICATION = 'mimic_47066.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "mimic_47066 API",
    "DESCRIPTION": "API documentation for mimic_47066 App",
    "VERSION": "v1",
}
